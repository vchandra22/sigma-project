...
class UpdatePasswordMentorController extends Controller
{
    /**
    ...
    public function edit(Admin $admin)
    {
        ...
        return view('mentor.update_password', $data);
    }
    ...
    public function update(Request $request, Admin $admin)
    {
        ...
        if (Hash::check($old_password, $currentPassword)) {
            ...
            return redirect(route('mentor.settings'))->with('success', 'Password baru berhasil diubah');
        } else {
