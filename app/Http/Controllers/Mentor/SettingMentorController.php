...
class SettingMentorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('mentor.settings', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('mentor.update_profile', $data);
    }
    ...
    public function update(Request $request, Admin $admin)
    {
        ...
        return redirect(route('mentor.settings'))->with('success', 'Data berhasil diupdate!');
    }
