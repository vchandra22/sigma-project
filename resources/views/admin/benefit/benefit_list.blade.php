                ...
                <div
                    ...
                    <div class="px-6 py-8 md:px-8 md:py-10 lg:px-12 lg:py-16">
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end">
                            ...
                            <div>
                                <a href="{{ route('admin.createBenefit') }}"
                                        ...
                                        <tr
                                            ...
                                            <td class="px-4 py-4">
                                                <p class="text-primary-800 dark:text-secondary">
                                                    {{ ($benefitData->currentPage() - 1) * $benefitData->perPage() + $loop->iteration }}
                                                </p>
                                            </td>
                                            <td class="px-4 py-4">
                                            ...
                                            <td class="px-8">
                                                <div class="flex items-center justify-center h-full gap-4">
                                                    <a href="{{ route('admin.editBenefit', $data->uuid) }}"
                                                        class="py-2 text-center text-md text-blue-500 hover:underline">
                                                        Edit
                                                    </a>
                                                    <form id="delete-benefit-{{ $data->id }}"
                                                        action="{{ route('admin.deleteBenefit', ['id' => $data->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    formToSubmit = document.getElementById('delete-benefit-' + this.dataset.id);
