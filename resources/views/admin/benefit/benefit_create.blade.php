                    ...
                    <div class="bg-gray-50 w-full border border-gray-100 dark:bg-neutral-800 dark:border-neutral-700">
                        <div class="px-6 py-8 md:px-8 md:py-10 lg:px-12 lg:py-16">
                            ...
                            <div class="mt-12">
                                ...
                                <form action="{{ route('admin.storeBenefit') }}" method="POST" class="space-y-6"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div>
                                        <label for="fa_icon"
                                            class="block mb-2 text-sm font-medium text-primary-800 dark:text-secondary">Font
                                            Awesome Icons
                                        ...
                                        <input type="text" name="fa_icon" id="fa_icon"
                                            ...
                                            required autofocus value="{{ old('fa_icon') }}" />
                                        @error('fa_icon')
                                        ...
                                        <ul class="list-disc ms-5 text-gray-500">
                                            <li>
                                                <p class="mt-1 text-xs text-gray-500 dark:text-secondary">
                                                    Pilih icon dari website <a href="https://fontawesome.com/icons"
                                                        target="_blank"
                                                        class="text-blue-500 hover:underline">https://fontawesome.com/icons</a>
                                                </p>
                                            </li>
                                            <li>
                                                <p class="mt-1 text-xs text-gray-500 dark:text-secondary">
                                                    Masukkan kode icon pada form input
                                                </p>
                                            </li>
                                            <li>
                                                <p class="mt-1 text-xs text-gray-500 dark:text-secondary">
                                                    Hanya kode dalam class tanpa tag "i" (fa-solid fa-users)
                                                </p>
                                            </li>
                                        </ul>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="detail" id="detail" rows="4"
                                            class="bg-white border border-abu-800 text-primary-800 text-sm focus:ring-primary-800 focus:border-primary-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder:text-neutral-400 dark:text-secondary dark:focus:ring-primary-800 dark:focus:border-accent">{{ old('detail') }}</textarea>
                                        @error('detail')
                                            <div class="mt-1 text-red-500 text-xs">
                                                {{ $message }}
                                            </div>
