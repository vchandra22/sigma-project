                    ...
                    <div class="bg-gray-50 w-full border border-gray-100 dark:bg-neutral-800 dark:border-neutral-700">
                        <div class="px-6 py-8 md:px-8 md:py-10 lg:px-12 lg:py-16">
                            ...
                            @foreach ($positionData as $position)
                                <form action="{{ route('admin.updatePosition', $position->id) }}" method="POST"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="role" id="role"
                                            ...
                                            required autofocus value="{{ $position->role }}" />
                                        @error('role')
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="deskripsi" id="deskripsi"
                                            class="bg-white border border-abu-800 text-primary-800 text-sm focus:ring-primary-800 focus:border-primary-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder:text-neutral-400 dark:text-secondary dark:focus:ring-primary-800 dark:focus:border-accent"
                                            required autofocus value="{{ $position->deskripsi }}" />
                                        @error('deskripsi')
                                            <div class="mt-1 text-red-500 text-xs">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="requirement" id="requirement"
                                            class="bg-white border border-abu-800 text-primary-800 text-sm focus:ring-primary-800 focus:border-primary-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder:text-neutral-400 dark:text-secondary dark:focus:ring-primary-800 dark:focus:border-accent"
                                            required autofocus value="{{ $position->requirement }}" />
                                        @error('requirement')
                                            <div class="mt-1 text-red-500 text-xs">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="upload-img-box h-auto w-full md:max-w-sm">
                                            @if ($position->gambar != null && $position->gambar != '')
                                                <img class="h-56 w-full overflow-y-hidden border-abu-500 rounded-sm border-2"
                                                    src="{{ asset('storage/img/' . $position->gambar) }}">
                                            @else
                                                <img class="h-56 w-full overflow-y-hidden border-abu-500 rounded-sm border-2"
                                    ...
                                    <div class="pt-8">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title"
                                            class="bg-white border border-abu-800 text-primary-800 text-sm focus:ring-primary-800 focus:border-primary-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder:text-neutral-400 dark:text-secondary dark:focus:ring-primary-800 dark:focus:border-accent"
                                            value="{{ old('meta_title', $position->meta_title) }}" />
                                        @error('meta_title')
                                            <div class="mt-1 text-red-500 text-xs">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords"
                                            class="bg-white border border-abu-800 text-primary-800 text-sm focus:ring-primary-800 focus:border-primary-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder:text-neutral-400 dark:text-secondary dark:focus:ring-primary-800 dark:focus:border-accent"
                                            value="{{ old('meta_keywords', $position->meta_keywords) }}" />
                                        @error('meta_keywords')
                                            <div class="mt-1 text-red-500 text-xs">
                                                {{ $message }}
                                            </div>
