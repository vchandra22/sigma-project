                    ...
                    <div class="px-6 py-8 md:px-8 md:py-10 lg:px-12 lg:py-16">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-2">
                            ...
                            <div
                                ...
                                @else
                                    <form
                                        action="{{ route('user.updateAssignment', ['assignment' => $assignmentData->id]) }}"
