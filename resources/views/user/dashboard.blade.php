            ...
            <div
                ...
                <div class="md:col-span-2 px-6 py-8">
                    ...
                    <p class="text-primary-800 font-paragraf text-md md:text-lg dark:text-secondary leading-4 md:leading-5">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat consequatur deleniti repellat fuga,
                        ...
                        deserunt nam laboriosam, quo, unde saepe. Atque numquam enim aspernatur eius non nostrum ad cumque!
                    </p>
                </div>
                <div>
                    <div
                ...
                <div class="w-full h-full">
                    <div class="md:grid md:grid-cols-2 gap-2 space-y-2 md:space-y-0">
                        <div class="h-full w-full grid grid-rows-3 gap-2">
                            ...
                            <div
                                class="px-6 py-8 bg-secondary border border-gray-100 dark:bg-neutral-700 dark:border-neutral-600">
                                <h2 class="text-xl md:text-2xl font-bold text-primary-800 dark:text-secondary mb-2">Jurusan
                                    / Bidang Keahlian</h2>
                                <p
                                    class="text-primary-800 font-paragraf text-lg md:text-xl dark:text-secondary leading-4 md:leading-5">
                            ...
                            <div
                                class="px-6 py-8 bg-secondary border border-gray-100 dark:bg-neutral-700 dark:border-neutral-600">
                                <h2 class="text-xl md:text-2xl font-bold text-primary-800 dark:text-secondary mb-2">Instansi
                                    Tujuan</h2>
                                <p
                                    class="text-primary-800 font-paragraf text-lg md:text-xl dark:text-secondary leading-4 md:leading-5">
                        ...
                        <div
                            ...
                            <h2 class="text-xl md:text-2xl font-bold text-primary-800 dark:text-secondary mb-4 text-center">
                                Status Pendaftaran</h2>
                            <div
                                class="text-center font-bold text-2xl md:text-3xl bg-yellow-300 rounded py-2 text-secondary mb-4">
                                <p>Menunggu</p>
                            </div>
                ...
                <div class="w-full h-full">
                    <div class="md:grid md:grid-cols-1 lg:grid-cols-3 gap-2 space-y-2 md:space-y-0">
                        <div
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <p>10 Maret 2024 - 10 Agustus 2024</p>
                                </div>
                            </div>
                            <div>
                                <h2 class="text-xl md:text-2xl font-bold text-primary-800 dark:text-secondary mb-4">Tanggal
                                    Magang yang Disetujui</h2>
                                <div
                                    class="text-start font-bold text-2xl text-primary-800 md:text-3xl py-2 dark:text-secondary mb-4">
                                    <p>24 Maret 2024 - 24 Agustus 2024</p>
                                </div>
                            </div>
                        </div>
                        <div class="h-full w-full grid grid-rows-2 gap-2">
                            ...
                            <div
                                class="p-4 bg-secondary border border-gray-100 dark:bg-neutral-700 dark:border dark:border-neutral-600" >
                                <h2 class="text-xl md:text-2xl font-bold text-primary-800 dark:text-secondary mb-2">Certificate of Internship</h2>
                                <p
                                    class="text-primary-800 font-paragraf text-lg md:text-xl dark:text-secondary leading-4 md:leading-5" >
