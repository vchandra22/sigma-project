    ...
    <div class="mt-[4.4rem] mx-auto h-96 md:h-full relative">
        ...
        <div
            ...
            <p
                ...
                Selamat datang di platform SIGMA, tempat di mana kesempatan menanti untukmu. Ayo kita eksplorasi beragam
                kegiatan magang yang sesuai dengan minat dan bakatmu,dengan proyek-proyek seru dan kamu dapat menjalin
                hubungan dengan para profesional berpengalaman. Yuk, kita bangun masa depan bareng. Gimana, tertarik jadi
                        ...
                        <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
                            <div class="p-5 border border-b-0 border-gray-200 dark:border-neutral-500 dark:bg-neutral-500">
                                <p class="mb-2 text-primary-800 font-paragraf text-lg leading-tight dark:text-secondary">
                                    Kamu harus melakukan pendaftaran Internship dengan melengkapi form pendaftaran pada menu
                                    “Register”
                                </p>
                            </div>
                        </div>
    ...
    <div class="bg-secondary dark:bg-neutral-900">
        <div class="max-w-screen-xl mx-auto py-24 px-4">
            ...
            <p class="text-center mt-4 text-2xl md:text-3xl text-primary-800 dark:text-secondary">
                Kunjungi <a class="font-bold hover:text-primary-500 dark:hover:text-abu-500" href="#">Instagram</a>
                dan <a class="font-bold hover:text-primary-500 dark:hover:text-abu-500" href="#">YouTube</a> Kami
                ya!
            </p>
        </div>
    </div>
            ...
            <div class="flex flex-col md:flex-col lg:flex-row justify-between items-center px-12">
                ...
                <div class="w-full h-full mt-8 md:w-2/3">
                    <iframe class="w-full h-80" width="560" height="315"
                        src="https://www.youtube.com/embed/NliKw6e0id8?si=p3kOKLLFsEZ8wmDM" title="YouTube video player"
                        frameborder="0"
