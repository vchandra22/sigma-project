        ...
        <div
            ...
            <div class="max-w-screen-xl px-4 mx-auto text-start grid grid-cols-1 content-between h-full">
                ...
                <div class="pb-20">
                    ...
                    <p class="text-sm text-gray-300 text-start pt-2">Dipublikasi Tanggal:
                        {{ convertDate($publikasiData->created_at) }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-span-2">
                    <div class="py-4 md:py-12 md:pr-12">
                        <div
                            ...
                            <p class="text-sm text-gray-600 text-start pt-2">Dipublikasi Tanggal:
                                {{ convertDate($publikasiData->created_at) }}</p>
